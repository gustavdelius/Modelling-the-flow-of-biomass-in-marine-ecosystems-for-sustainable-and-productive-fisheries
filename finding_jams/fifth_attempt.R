...
initialN(params)[, idx] <- initialN(params)[, idx] /10^(3)
params@initial_n_pp[] <- params@cc_pp*0.1
sim <- project(params, t_max = 100,dt=p$dt, progress_bar = FALSE,method="predictor-corrector")
...
animateSpectra(simc,log="y",power=2)



############################# Slightly spruced up version ##########
