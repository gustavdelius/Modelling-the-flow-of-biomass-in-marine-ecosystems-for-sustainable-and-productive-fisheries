...
description: "Following up on Day 20's corrected result, biomass is now tracked over time (not just settled max/min) for a chained forward/backward pair, revealing clear hysteresis at resource_decrease = 0.05. A few further threads were started but left unfinished."
---
